...
export default function FileUploadStep({ onFileUpload }) {
  ...
  return (
    <div className="space-y-6">
      <DialogHeader>
        ...
        <DialogDescription>Select a CSV file containing your transaction data</DialogDescription>
      </DialogHeader>

      <div
        className="w-full border-2 border-dashed rounded-lg text-center"
        style={{ padding: "32px" }}
      >
        <input
          type="file"
